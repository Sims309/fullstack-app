...
const logger_1 = __importDefault(require("./logger")); // ✅ Logger ajouté
...
db.connect(err => {
    if (err)
        logger_1.default.error('❌ Erreur connexion MySQL : %s', err.message); // ✅ log avec Winston
    else
